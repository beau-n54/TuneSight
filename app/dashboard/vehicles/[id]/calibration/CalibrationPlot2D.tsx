...
export default function CalibrationPlot2D({ model, direction, sliceIndex, terminology, onSelect }: {
  ...
  return (
    <div className="overflow-x-auto" aria-label="Linked 2D Calibration view">
      <svg className="min-w-[760px]" viewBox={`0 0 ${width} ${height}`} role="img" aria-label={`Reference and Current ${labels.output.label} by ${axisTerm?.label ?? axis.id}`}>
