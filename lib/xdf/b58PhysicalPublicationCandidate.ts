...
export const FOUNDER_00003076501103_DEFINITION_SOURCE = xdf;
export const FOUNDER_00003076501103_DEFINITION_SET = defineDefinitionSetRevision({ sourceArtifact: xdf.sourceArtifact!, definitions: xdf.definitions });
export const FOUNDER_00003076501103_DEFINITIONS = xdf.definitions;
